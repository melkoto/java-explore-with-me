...
import ru.practicum.main.event.dto.EventResponseDto;
...
public class AdminEventController {
    ...
    @GetMapping
    public ResponseEntity<List<EventResponseDto>> getEvents(@RequestParam(name = "users", required = false) List<Long> users,
    ...
    public ResponseEntity<EventResponseDto> updateEvent(@PathVariable @NotNull Long eventId,
